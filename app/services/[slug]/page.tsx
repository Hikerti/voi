  ...
  return (
    <>
      ...
      <main className="vs-page-shell vs-page-shell--dark service-detail-page">
        ...
        <section className={sidebarStyles.detailSection} aria-labelledby="service-includes-title">
          <ServiceSidebar services={allServices} currentSlug={slug} />
          <div className={`${sidebarStyles.detailContent} rich-content`}>
        ...
        <section className={sidebarStyles.orderSection}>
